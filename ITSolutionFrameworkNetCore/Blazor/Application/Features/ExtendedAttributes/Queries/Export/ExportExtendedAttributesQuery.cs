...
using ITSolution.Framework.Blazor.Application.Specifications.ExtendedAttribute;
using ITSolution.Framework.Blazor.Domain.Contracts;
using ITSolution.Framework.Blazor.Domain.Enums;
using ITSolution.Framework.Blazor.Shared.Wrapper;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Localization;

namespace ITSolution.Framework.Blazor.Application.Features.ExtendedAttributes.Queries.Export
{
