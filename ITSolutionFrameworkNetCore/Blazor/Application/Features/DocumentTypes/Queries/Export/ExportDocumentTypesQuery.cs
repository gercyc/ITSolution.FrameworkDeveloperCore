...
using ITSolution.Framework.Blazor.Application.Specifications.Misc;
...
namespace ITSolution.Framework.Blazor.Application.Features.DocumentTypes.Queries.Export
{
