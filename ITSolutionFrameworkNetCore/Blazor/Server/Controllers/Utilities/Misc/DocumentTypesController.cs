...
using ITSolution.Framework.Blazor.Application.Features.DocumentTypes.Commands.Delete;
using ITSolution.Framework.Blazor.Application.Features.DocumentTypes.Queries.Export;
...
namespace ITSolution.Framework.Blazor.Server.Controllers.Utilities.Misc
{
