...
using ITSolution.Framework.Blazor.Application.Features.ExtendedAttributes.Commands.Delete;
...
namespace ITSolution.Framework.Blazor.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
