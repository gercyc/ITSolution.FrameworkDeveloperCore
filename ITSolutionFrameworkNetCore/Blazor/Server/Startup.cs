...
using ITSolution.Framework.Blazor.Server.Extensions;
using ITSolution.Framework.Blazor.Server.Middlewares;
using Hangfire;
...
using System.IO;
using ITSolution.Framework.Blazor.Server.Filters;
using ITSolution.Framework.Blazor.Server.Managers.Preferences;
using Microsoft.Extensions.Localization;
using Hangfire.Storage.SQLite;

namespace ITSolution.Framework.Blazor.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHangfire(x => x.UseSQLiteStorage(_configuration.GetConnectionString("SQLiteConnection").Replace("Data Source=", "")));
